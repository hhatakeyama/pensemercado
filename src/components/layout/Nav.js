...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-lg bg-slate-900/60 shadow-[0_1px_0_rgba(255,255,255,.05)]">
      <div className="container mx-auto flex items-center justify-between px-5 py-4 lg:py-4">
        ...
        <nav aria-label="Principal" className="hidden md:block">
          <ul className="flex gap-0 lg:gap-4 list-none m-0 p-0">
            <li><a href="#inicio" className="block px-3 py-2 rounded-lg text-slate-300 hover:bg-slate-800">Início</a></li>
